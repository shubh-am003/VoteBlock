...
contract Election {
    ...
    constructor () public {
        addCandidate("Devendra Fandvis","Bharatiya Janata Party");
        addCandidate("Ashok Chauhan","Indian National Congress");
        addCandidate("Udhav Thakre","Shivsena");
        addCandidate("Waris Pathan","AIMIM");
